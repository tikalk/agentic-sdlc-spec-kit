...
class TestCopilotSkillsMode:
    ...
    def test_build_command_invocation_skills_mode(self):
        ...
        # Plain name: canonicalized to speckit.plan before alias resolution
        assert copilot.build_command_invocation("plan") == f"/{pfx}-plan"
        assert copilot.build_command_invocation("plan", "my args") == f"/{pfx}-plan my args"
    ...
    def test_skills_mode_resets_between_layouts(self, tmp_path):
        ...
        assert copilot._skills_mode is True
        assert copilot.build_command_invocation("plan") == f"/{_skill_prefix('plan')}-plan"
