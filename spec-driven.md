...
/spec.specify Real-time chat system with message history and user presence
...
/spec.plan WebSocket for real-time messaging, PostgreSQL for history, Redis for presence
