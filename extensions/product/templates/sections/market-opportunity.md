...
|---------|------|-------------|--------|
| **TAM** | $[N]B | [Total addressable market description] | [Source/year] |
...
|------------|----------|----------|---------------------|
| [Competitor 1] | [Their approach] | [What they do well] | [How we differ] |
| [Competitor 2] | [Their approach] | [What they do well] | [How we differ] |
...
|-----------|---------------|-------------|
| **Now** | [Current market state] | [Why act now] |
| **6 months** | [Near-term trend] | [First-mover opportunity] |
...
**Title/Role:** [Target buyer role]
**Company Profile:** [Size, industry, stage]

| Attribute | Description |
|-----------|-------------|
| **Pain** | [Primary pain point driving purchase] |
| **Budget** | $[Range]/year for this category |
| **Decision Cycle** | [Typical timeline] |
| **Success Criteria** | [What they need to see to buy] |
...
|-----|----------|------------------------------|
| [PDR-XXX] | [Decision] | [How it defines market positioning] |
