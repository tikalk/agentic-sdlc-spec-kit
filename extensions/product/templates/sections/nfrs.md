# Non-Functional Requirements: [FEATURE_AREA_NAME]
...
|-------------|--------|-------------|
| Response Time | [e.g., < 200ms p95] | [How to measure] |
...
|-------------|----------|------------|
| Authentication | [e.g., OAuth 2.0] | [Compliance requirement] |
...
| Requirement | Target | Measurement |
|-------------|--------|-------------|
| Availability | [e.g., 99.9%] | [SLA definition] |
...
| Requirement | Target | Measurement |
|-------------|--------|-------------|
| Learnability | [e.g., < 30 min to first task] | [How to measure] |
...
| Requirement | Target | Measurement |
|-------------|--------|-------------|
| Concurrent Users | [e.g., 10,000] | [Load testing] |
...
|--------------|-------------|-----|-----------|
| [Type] | [Requirement] | PDR-XXX | [Why this NFR] |
...
|-----|----------|----------------|
| [PDR-XXX] | [Decision] | [How it defines quality attributes] |
