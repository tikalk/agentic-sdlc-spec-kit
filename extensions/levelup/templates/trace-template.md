...
**Usage**: This trace can be consumed by `/levelup.specify` for extracting Context Decision Records (CDRs) and analyzing contributions to team-ai-directives (rules, constitution, personas, examples, skills).
