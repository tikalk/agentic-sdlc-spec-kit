---
description: TPR/TNR + goldset quality + PromptFoo pass rate thresholds validation following EDD compliance verification
scripts:
  sh: scripts/bash/setup-evals.sh "validate {ARGS}"
  ps: scripts/powershell/setup-evals.ps1 "validate {ARGS}"
---
