...
Located in the extension's `.specify/templates/sections/` directory:

| Template | Purpose |
|----------|---------|
| `.specify/templates/sections/overview.md` | Overview section template |
| `.specify/templates/sections/problem.md` | Problem section template |
| `.specify/templates/sections/goals.md` | Goals/Objectives section template |
| `.specify/templates/sections/metrics.md` | Success Metrics section template |
| `.specify/templates/sections/personas.md` | Personas section template |
| `.specify/templates/sections/requirements.md` | Functional Requirements section template |
| `.specify/templates/sections/nfrs.md` | Non-Functional Requirements section template |
| `.specify/templates/sections/out-of-scope.md` | Out of Scope section template |
| `.specify/templates/sections/risks.md` | Risks & Mitigation section template |
| `.specify/templates/sections/roadmap.md` | Roadmap & Milestones section template |
| `.specify/templates/sections/pdr-summary.md` | PDR Summary section template |
...
**Script Action**: Run `.specify/extensions/product/scripts/bash/setup-product.sh "implement $ARGUMENTS"` which calls `plan-dag` internally
...
3. **Load Section Template**: Read from `.specify/templates/sections/{section}.md`
...
**Template**: `.specify/templates/sections/overview.md`
...
**Template**: `.specify/templates/sections/problem.md`
...
**Template**: `.specify/templates/sections/goals.md`
...
**Dependencies**: Goals
**Template**: `.specify/templates/sections/metrics.md`
...
**Template**: `.specify/templates/sections/personas.md`
...
**Template**: `.specify/templates/sections/requirements.md`
...
**Template**: `.specify/templates/sections/nfrs.md`
...
**Dependencies**: Requirements
**Template**: `.specify/templates/sections/out-of-scope.md`
...
**Dependencies**: Requirements
**Template**: `.specify/templates/sections/risks.md`
...
**Template**: `.specify/templates/sections/roadmap.md`
...
**Template**: `.specify/templates/sections/pdr-summary.md`
