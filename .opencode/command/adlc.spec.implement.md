...
description: Execute the implementation plan by processing and executing all tasks
  defined in tasks.md
scripts:
  sh: .specify/scripts/bash/implement.sh "$(.specify/scripts/bash/check-prerequisites.sh
    --json --require-tasks --include-tasks)"
  ps: .specify/scripts/powershell/implement.ps1 "$(.specify/scripts/powershell/check-prerequisites.ps1
