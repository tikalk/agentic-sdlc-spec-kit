...
class PresetManager:
    ...
    def _register_commands(
        ...
        # Tikalk fork: clean up replaced core commands (replaces: feature)
    ...
    def _resolve_skill_command_refs(
        ...
        return IntegrationBase.resolve_command_refs(body, separator, project_root, prefix)
    ...
    def _register_skills(
        ...
        *,
        ...
        for cmd_tmpl in filtered:
            ...
            # Tikalk fork: resolve handoff agents and canonical command names
            # (not handled by _resolve_skill_command_refs)
            from ..integrations.base import IntegrationBase
