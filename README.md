...
| Microsoft 365 Integration | Fetch Teams messages, meeting transcripts, and SharePoint/OneDrive files as local Markdown for spec generation | `docs` | Read+Write | [spec-kit-m365](https://github.com/BenBtg/spec-kit-m365) |
