...
gh release create "$VERSION" \
  ...
  .genreleases/agentic-sdlc-spec-kit-template-cursor-agent-sh-"$VERSION".zip \
  .genreleases/agentic-sdlc-spec-kit-template-cursor-agent-ps-"$VERSION".zip \
  ...
  .genreleases/agentic-sdlc-spec-kit-template-codebuddy-sh-"$VERSION".zip \
  .genreleases/agentic-sdlc-spec-kit-template-codebuddy-ps-"$VERSION".zip \
  .genreleases/agentic-sdlc-spec-kit-template-qodercli-sh-"$VERSION".zip \
  .genreleases/agentic-sdlc-spec-kit-template-qodercli-ps-"$VERSION".zip \
  .genreleases/agentic-sdlc-spec-kit-template-amp-sh-"$VERSION".zip \
  .genreleases/agentic-sdlc-spec-kit-template-amp-ps-"$VERSION".zip \
  .genreleases/agentic-sdlc-spec-kit-template-shai-sh-"$VERSION".zip \
  .genreleases/agentic-sdlc-spec-kit-template-shai-ps-"$VERSION".zip \
  .genreleases/agentic-sdlc-spec-kit-template-tabnine-sh-"$VERSION".zip \
  .genreleases/agentic-sdlc-spec-kit-template-tabnine-ps-"$VERSION".zip \
  .genreleases/agentic-sdlc-spec-kit-template-kiro-cli-sh-"$VERSION".zip \
  .genreleases/agentic-sdlc-spec-kit-template-kiro-cli-ps-"$VERSION".zip \
  .genreleases/agentic-sdlc-spec-kit-template-agy-sh-"$VERSION".zip \
  .genreleases/agentic-sdlc-spec-kit-template-agy-ps-"$VERSION".zip \
  .genreleases/agentic-sdlc-spec-kit-template-bob-sh-"$VERSION".zip \
  .genreleases/agentic-sdlc-spec-kit-template-bob-ps-"$VERSION".zip \
  .genreleases/agentic-sdlc-spec-kit-template-vibe-sh-"$VERSION".zip \
  .genreleases/agentic-sdlc-spec-kit-template-vibe-ps-"$VERSION".zip \
  .genreleases/agentic-sdlc-spec-kit-template-kimi-sh-"$VERSION".zip \
  .genreleases/agentic-sdlc-spec-kit-template-kimi-ps-"$VERSION".zip \
  .genreleases/agentic-sdlc-spec-kit-template-trae-sh-"$VERSION".zip \
