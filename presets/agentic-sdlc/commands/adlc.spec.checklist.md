...
- `checklists/requirements.md` is a separate built-in spec-quality checklist maintained by `/spec.specify` and `/spec.clarify`; do not treat that exception as applying to custom checklists generated here.
